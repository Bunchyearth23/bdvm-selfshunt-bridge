...
This file is the published compatibility contract for **BDVM.SelfShuntBridge 1.1.0**. It describes the current incremental release; it is not a promise that BDVM is feature-complete.
...
| External runtime dependencies | SelfShunt and SelfShunt.API | A missing optional runtime disables only the dependent bridge or feature. |
